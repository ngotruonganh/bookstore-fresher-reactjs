...
const Home = () => {
    ...
    return (
        <>
            ...
            <Row gutter={[16, 16]}>
                <Col xs={24} md={5} style={{backgroundColor: 'white', borderRadius: "3px", paddingTop: "10px"}} className='filter-d'>
                    <Drawer
                        title="Filter"
                        placement='left'
                        closable={true}
                ...
                <Col xs={24} md={19}>
                    {/*sort*/}
                    <Row justify="space-between" align='middle' style={{backgroundColor: 'white', padding: '20px',  borderRadius: "3px"}}>
                        <Col>
                                ...
                                <Col>
                                    ...
                                    >
                                        {sort === "sort=price" || sort === "sort=-price" ? (
                                            <Button type='primary' danger style={{width: '200px', display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                                                <span>
                                                    Price: {sort === 'sort=price' ? 'Low to High': 'High to Low'}
                                                </span>
                                                <DownOutlined/>
                                            </Button>) : (
                                            <Button danger style={{width: '200px', display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                                                Price
                                                <DownOutlined/>
                                            </Button>)
                                        }
                    ...
                    <Row gutter={[8, 8]} style={{marginTop: "20px",  borderRadius: "3px"}}>
                        {listBook.map((item) => {
                            return (
                                <Col key={item._id} onClick={() => handleViewDetailInOrder(item)} xs={24} sm={12} lg={8} xl={6} xxl={4} style={{padding: '10px'}}>
